...
[![Man hours](https://img.shields.io/endpoint?url=https%3A%2F%2Fmanhours.aiursoft.com%2Fr%2Fgithub.com%2Faimerneige%2Fmuse-oracle-engine.json)](https://manhours.aiursoft.com/r/github.com/aimerneige/muse-oracle-engine.html)
...
圣谕自演机是一个面向多 IP 角色的二次元漫画创作工具。项目将角色资料、故事模板和画风模板打包进静态网页，让用户可以在浏览器中组织角色与剧情、生成 Prompt，并通过手动粘贴模型结果完成标准漫画、长篇漫画或四格漫画的创作流程。
...
- 支持人工审阅、项目检查点、断点续跑、单张图片重试、长篇漫画与四格漫画流程。
...
go run cmd/generate/main.go --long-manga --characters 'lovelive/honoka' --plot '社团一年的日常' --style watercolor --story-length 4
go run cmd/generate/main.go --four-panel-manga --characters 'lovelive/honoka' --plot '放学后的小插曲' --style chibi_figure
```
